          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {socials.map((social, i) => (
              <a
                ...
                className="flex items-center gap-4 bg-white/80 backdrop-blur-sm border border-blue-200/50 rounded-xl px-5 py-4 hover:bg-gradient-to-r hover:from-blue-600 hover:to-purple-600 hover:text-white hover:border-transparent hover:shadow-xl hover:-translate-y-1 transition-all duration-500 group relative overflow-hidden"
